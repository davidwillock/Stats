...
import com.charlie1.simulator.client.BinanceApiAsyncRestClient;
import com.charlie1.simulator.client.BinanceApiCallback;
import com.charlie1.simulator.client.constant.BinanceApiConstants;
import com.charlie1.simulator.client.domain.account.Account;
import com.charlie1.simulator.client.domain.account.DepositAddress;
import com.charlie1.simulator.client.domain.account.DepositHistory;
import com.charlie1.simulator.client.domain.account.NewOrder;
import com.charlie1.simulator.client.domain.account.NewOrderResponse;
import com.charlie1.simulator.client.domain.account.Order;
import com.charlie1.simulator.client.domain.account.Trade;
import com.charlie1.simulator.client.domain.account.WithdrawHistory;
import com.charlie1.simulator.client.domain.account.request.AllOrdersRequest;
import com.charlie1.simulator.client.domain.account.request.CancelOrderRequest;
import com.charlie1.simulator.client.domain.account.request.OrderRequest;
import com.charlie1.simulator.client.domain.account.request.OrderStatusRequest;
import com.charlie1.simulator.client.domain.event.ListenKey;
import com.charlie1.simulator.client.domain.general.ExchangeInfo;
import com.charlie1.simulator.client.domain.general.ServerTime;
import com.charlie1.simulator.client.domain.market.AggTrade;
import com.charlie1.simulator.client.domain.market.BookTicker;
import com.charlie1.simulator.client.domain.market.Candlestick;
import com.charlie1.simulator.client.domain.market.CandlestickInterval;
import com.charlie1.simulator.client.domain.market.OrderBook;
import com.charlie1.simulator.client.domain.market.TickerPrice;
import com.charlie1.simulator.client.domain.market.TickerStatistics;

import java.util.List;

import static com.charlie1.simulator.client.impl.BinanceApiServiceGenerator.createService;
